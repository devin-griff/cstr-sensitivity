...
RUN STATIC=$(python -c "import streamlit, os; print(os.path.join(os.path.dirname(streamlit.__file__), 'static'))") \
    && sed -i 's|<title>Streamlit</title>|<title>CSTR Sensitivity</title>|' "$STATIC/index.html" \
    && sed -i 's|</head>|<link rel="icon" type="image/png" href="./favicon.png"/><meta property="og:type" content="website"/><meta property="og:title" content="CSTR Sensitivity"/><meta property="og:description" content="Local feedback gains from one solve: parametric sensitivity on a CSTR"/><meta property="og:image" content="https://griffith-pse.com/images/cstr-sensitivity.png"/><meta property="og:site_name" content="Griffith PSE"/><meta name="twitter:card" content="summary_large_image"/><meta name="twitter:title" content="CSTR Sensitivity"/><meta name="twitter:description" content="Local feedback gains from one solve: parametric sensitivity on a CSTR"/><meta name="twitter:image" content="https://griffith-pse.com/images/cstr-sensitivity.png"/></head>|' "$STATIC/index.html" \
